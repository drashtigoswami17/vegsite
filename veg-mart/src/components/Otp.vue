          ...
          <div class="container-fluid">
            <nav class="navbar navbar-expand-lg custom_nav-container"
              ...
              <div
                ...
                <label @click="$router.push('/register')">Regsiter</label></div>
            </nav>
          </div>
        </header>
        <!-- end header section -->
      ...
      <div class="container" style="alignment: center">
        <div class="cover">
          <div class="front">
            <img src="../assets/images/backimg.jpg" alt="" />
            <div class="text">
              <span class="text-1">WE SERVE FRESH<br />PRODUCTS</span>
              <span class="text-2">YOUR HEALTH IS OUR FIRST PRIORITY</span>
            </div>
          </div>
          <div class="back">
            <div class="text">
              <span class="text-1">VegMart <br />is here</span>
              <span class="text-2">to serve you</span>
            </div>
          </div>
        </div>
        <div class="forms">
...
<script>
  ...
  export default {
    mounted() {
      ...
      // firebase
      //   .auth()
      //   .signInWithPhoneNumber("+917490972908", appVerifier)
